...
//        Task<string> Register(UserRegisterRequest registerRequest, CancellationToken cancellationToken);
...
//        Task<IReadOnlyCollection<UserSummary>> GetAll(int take, int skip, CancellationToken cancellationToken);
...
//        Task<UserDetails> GetById(string id, CancellationToken cancellationToken);
...
//        /// <param name="cancellationToken"></param>
//        Task UpdateAsync(string id, UserUpdateRequest updateRequest, CancellationToken cancellationToken);
