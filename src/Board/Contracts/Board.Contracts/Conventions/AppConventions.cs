...
namespace Board.Contracts.Conventions
{
    public static class AppConventions
    {
        ...
        [ProducesResponseType(typeof(ErrorDto), StatusCodes.Status422UnprocessableEntity)]
        [ProducesResponseType(typeof(ErrorDto), StatusCodes.Status500InternalServerError)]
        public static void Send([ApiConventionTypeMatch(ApiConventionTypeMatchBehavior.Any)] params object[] p)
        {
        ...
        [ProducesResponseType(typeof(ErrorDto), StatusCodes.Status422UnprocessableEntity)]
        [ProducesResponseType(typeof(ErrorDto), StatusCodes.Status500InternalServerError)]
        public static void Change([ApiConventionTypeMatch(ApiConventionTypeMatchBehavior.Any)] params object[] p)
        {
