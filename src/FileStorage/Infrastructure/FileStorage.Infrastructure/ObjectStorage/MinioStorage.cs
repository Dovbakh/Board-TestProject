...
namespace FileStorage.Infrastructure.ObjectStorage
{
    public class MinioStorage : IObjectStorage
    {
        ...
        private MinioClient CreateStorage()
        {
            ...
            var accessKey = "K4cRXEvosR6HScb6"; // _configuration.GetSection(MinioAccessName).GetRequiredSection("AccessKey").Value;
            var secretKey = "KBff4dBPm0vztkmh0jsh49Zft1sfARSt"; // _configuration.GetSection(MinioAccessName).GetRequiredSection("SecretKey").Value;
