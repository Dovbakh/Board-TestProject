...
{
    public class MigrationPersistedGrantDbContextFactory : IDesignTimeDbContextFactory<MigrationPersistedGrantDbContext>
    {
        public MigrationPersistedGrantDbContext CreateDbContext(string[] args)
        {
